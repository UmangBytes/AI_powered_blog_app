...
const TagInput = ({tags,setTags}) => {
  ...
  return (
    <div className='flex flex-wrap gap-2 items-center border border-gray-300 rounded-md min-h-[48px] mt-3'>
      {tags.map((tag,index)=>(
        <div
        key={index}
      ...
      className='flex-1 min-w-[120px] border-none outline-none text-sm p-2'
      />
