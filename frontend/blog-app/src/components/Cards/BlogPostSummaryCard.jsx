  ...
  return (
    ...
    >
      <img src={imgUrl} alt={title} className='w-16 h-16 rounded-lg' />
        ...
        <button
        className='hidden md:group-hover:flex items-center gap-2 text-xs text-rose-500 font-medium bg-rose-50 px-3 py-1 text-nowrap border border-rose-100 hover:border-rose-200 cursor-pointer rounded'
        onClick={(e)=>{
           e.stopPropagation();
           onDelete(); 
        }}
