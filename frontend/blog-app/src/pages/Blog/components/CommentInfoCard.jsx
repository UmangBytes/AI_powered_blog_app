                        ...
                        <p className="text-sm text-black font-medium">{content}</p>
                         ...
                         <div className="flex items-center gap-3 mt-1.5">
                            {!isSubReply &&(
                                <>
                                <button
                                className="flex items-center gap-2 text-[13px] font-medium text-sky-600 bg-sky-50 px-4 py-0.5 hover:bg-sky-500 hover:text-white cursor-pointer rounded-full"
                                onClick={()=>{
                                    if(!user){
