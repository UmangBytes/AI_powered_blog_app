          ...
          <div className='grid grid-cols-12 gap-8 relative'>
              ...
              <div className='flex items-center flex-wrap gap-2'>
                {blogPostData.tags.slice(0,3).map((tag,index)=>(
                  <button
                  key={index}
                  className='bg-sky-200/50 text-gray-800/80 text-xs font-medium px-3 py-0.5 rounded-full text-nowrap cursor-pointer'
                  onClick={(e)=>{
                    e.stopPropagation();
                    navigate(`tag/${tag}`)
                  }}
              ...
              <div>
                <MarkdownContent 
                  content={santizeMarkdown(blogPostData?.content || "")}
                  />
                  ...
                  <div className='bg-gray-50 p-4 rounded-lg'>
                    <div className='flex items-center justify-between mb-4'>
                      ...
                      <button
                      className='flex items-center justify-center gap-3 bg-linear-to-r from-sky-500 to-cyan-400 font-semibold text-white px-5 py-2 rounded-full hover:bg-black hover:text-white cursor-pointer'
                      onClick={()=>{
                        if(!user){
                      ...
                      {showReplyForm && (
                        <div className='bg-white pt-1 pb-5 rounded-lg mb-8 '>
                          <CommentReplyInput 
                          user={user}
